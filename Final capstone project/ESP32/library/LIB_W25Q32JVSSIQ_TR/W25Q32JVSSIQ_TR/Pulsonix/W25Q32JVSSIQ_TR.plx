...
//641952/1526934/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "W25Q32JVSSIQ_TR" (originalName "W25Q32JVSSIQ_TR")
	...
	(compDef "W25Q32JVSSIQ_TR" (originalName "W25Q32JVSSIQ_TR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "IO3") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "W25Q32JVSSIQ_TR"))
		...
		(attr "Manufacturer_Part_Number" "W25Q32JVSSIQ TR")
		(attr "Mouser Part Number" "454-W25Q32JVSSIQTR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Winbond/W25Q32JVSSIQ-TR?qs=qSfuJ%252Bfl%2Fd73AdQzQa%2FEuA%3D%3D")
		(attr "Arrow Part Number" "W25Q32JVSSIQ TR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/w25q32jvssiqtr/winbond-electronics?utm_currency=USD&region=nac")
		(attr "Description" "NOR Flash spiFlash, 32M-bit, DTR, 4Kb Uniform Sector")
		(attr "<Hyperlink>" "https://www.winbond.com/resource-files/w25q32jv%20spi%20revc%2008302016.pdf")
		(attr "<Component Height>" "2.16")
		(attr "<STEP Filename>" "W25Q32JVSSIQ_TR.stp")
